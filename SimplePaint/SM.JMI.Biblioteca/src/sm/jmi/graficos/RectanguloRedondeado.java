...
public class RectanguloRedondeado extends RoundRectangle2D.Double{
    ...
    public RectanguloRedondeado(Point p){
        super(p.x,p.y,0,0,5,5);
        this.fill = false;
        this.grosor = 1;
    ...
    public RectanguloRedondeado(Point p,double width,double height,double arcox,double arcoy){
        super(p.x,p.y,width,height,arcox,arcoy);
        this.fill = false;
        this.grosor = 1;
        this.patronTrazo = null;
        this.trazo = new BasicStroke(this.grosor,BasicStroke.CAP_SQUARE,BasicStroke.JOIN_MITER,1.0f,this.patronTrazo,1.0f);
    ...
    public RectanguloRedondeado(Point2D p,double width,double height,double arcox,double arcoy){
        super(p.getX(),p.getY(),width,height,arcox,arcoy);
        this.fill = false;
        this.grosor = 1;
        this.patronTrazo = null;
        this.trazo = new BasicStroke(this.grosor,BasicStroke.CAP_SQUARE,BasicStroke.JOIN_MITER,1.0f,this.patronTrazo,1.0f);
    ...
    public RectanguloRedondeado(double x,double y,double width,double height,double arcox,double arcoy){
        super(x,y,width,height,arcox,arcoy);
        this.fill = false;
        this.grosor = 1;
        this.patronTrazo = null;
        this.trazo = new BasicStroke(this.grosor,BasicStroke.CAP_SQUARE,BasicStroke.JOIN_MITER,1.0f,this.patronTrazo,1.0f);
